  ...
  const categories = [
    {
      ...
      hasArrow: true,
      SubRubrikalar: [
        { name: t("economic"), route: `/${locale}/navigation/economic` },
        { name: t("literature"), route: `/${locale}/navigation/literature` },
        { name: t("politics"), route: `/${locale}/navigation/politics` },
        { name: t("society"), route: `/${locale}/navigation/society` },
        { name: t("madaniyat"), route: `/${locale}/navigation/madaniyat` },
        { name: t("media"), route: `/${locale}/navigation/media` },
        { name: t("mekendesh"), route: `/${locale}/navigation/mekendesh` },
        { name: t("ospurum"), route: `/${locale}/navigation/ospurum` },
      ],
    },
    ...
    { name: t("Islam"), hasArrow: false },
    {
      name: t("nuska"),
      hasArrow: true,
      SubNuska: [{ name: t("contest"), route: `/${locale}/navigation/contest` }],
    },
    {
      name: t("aboutUs"),
      hasArrow: true,
      SubBiz: [
        { name: t("aboutSite"), route: `/${locale}/navigation/aboutSite` },
        { name: t("contact"), route: `/${locale}/navigation/contact` },
      ],
    },
